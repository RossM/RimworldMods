...
/// </summary>
/// <remarks>
///     The library looks for a static method named <c>ImpliedDefs</c> that takes a <see cref="bool" /> and returns a value
///     convertible
///     to <see cref="IEnumerable{T}" />, where <c><see langword="typeof" />(T)</c> matches <paramref name="defType" />. It
///     runs the method after the base
///     game def generators run, then adds the returned defs to <see cref="DefDatabase{T}" />.
/// </remarks>
/// <param name="defType">
///     The <see cref="Def" /> subclass generated by <c>ImpliedDefs</c>, such as <see cref="ThingDef" /> or
///     <see cref="GeneDef" />.
/// </param>
/// <example>
///     <code>
