...
| youthful ([`XylYouthful`](Defs/GeneDefs/GeneDefs_Reproduction.xml)) | Caps the age used in lovin' frequency, lovin' age-factor, and relationship-compatibility calculations at 18. Does not stop biological aging, prevent age-related illness, or extend lifespan. |
