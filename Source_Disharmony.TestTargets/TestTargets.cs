namespace Disharmony.Tests
{
    ...
    public static class InlinePatchPatches
    {
        ...
        public static void InlinePrefix_ArgumentOpcodes_LdargS_LdargaS_StargS(
            int first,
            int second,
            int third,
            int fourth,
        ...
        public static void InlinePrefix_LocalOpcodes_LdlocS_Stloc0_StlocS()
        {
            int local0 = 10;
            int local1 = 11;
            int local2 = 12;
        ...
        public static void InlinePrefix_SwitchOpcode(int value)
        {
            switch (value)
            {
    ...
    public static class InlinePatchTargets
    {
